                        ...
                        <form id="podcastEditForm" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="title" class="form-control" value="{{ $podcast->title }}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="slug" name="slug" class="form-control" value="{{ $podcast->slug }}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="video_url" name="video_url" class="form-control" value="{{ $podcast->video_url }}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea id="description" name="description" class="form-control">{{ $podcast->description }}</textarea>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="date" id="published_at" name="published_at" class="form-control" value="{{ $podcast->published_at }}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="number" id="duration" name="duration" class="form-control" value="{{ $podcast->duration }}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="checkbox" id="is_latest" name="is_latest" value="1" {{ $podcast->is_latest ? 'checked' : '' }}>
...
<script>
    document.querySelector('#update').addEventListener('click', function() {
        ...
        fetch('{{ route("podcasts.update", $podcast->id) }}', {
            method: 'POST',
            headers: {
